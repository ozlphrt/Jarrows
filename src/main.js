...
import {
    ...
    getEligibleBlocksForBlastTuning,
    computeBlastCellStats,
    getBlockSpatialCenter,
    calculateBlockBombScore,
    applyBlastCellPercentToCurrentTower,
...
if (typeof window !== 'undefined') {
    ...
    window.applyLightPreset = applyLightPreset;
    window.LIGHT_PRESETS = LIGHT_PRESETS;
}
...
// Head-on collision puzzle generator is now encapsulated in src/puzzle/LevelGenerator.js
